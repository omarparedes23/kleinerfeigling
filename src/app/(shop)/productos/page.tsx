  ...
  return (
    <div className="min-h-screen bg-black text-white pb-20">
      ...
      <div className="relative overflow-hidden border-b border-neutral-900 bg-neutral-950/40 py-16 sm:py-20 backdrop-blur-xl">
        {/* Neon Glow Effects */}
        <div className="absolute -bottom-10 left-1/4 w-72 h-72 rounded-full bg-lime-500/10 filter blur-[80px] pointer-events-none" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-4">
          <span className="text-[10px] sm:text-xs font-black uppercase text-lime-400 tracking-[0.3em] block">
